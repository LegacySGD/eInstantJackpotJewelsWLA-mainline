...
public class JackpotJewelsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JackpotJewelsWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/JackpotJewelsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JackpotJewelsWLAIW/InitOutcome.xml").getDocumentElement();
